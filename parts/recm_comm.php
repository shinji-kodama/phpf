...
if($status==false) {
    ...
    $view = '<p style="width;auto;color:brown;font-size:16px;text-align:center;border-bottom:solid 1px brown;background-color:rgba(255,255,255,0.5);">Community you join</p>';
...
if($status==false) {
    ...
    $view .= '<p style="width;auto;color:brown;font-size:16px;text-align:center;border-bottom:solid 1px brown;border-top:solid 1px brown;background-color:rgba(255,255,255,0.5);">All Communities</p>';
    while( $r = $stmt->fetch(PDO::FETCH_ASSOC)){
        $c_name = h($r['com_name']);
        $c_icon = h($r['com_icon']);
